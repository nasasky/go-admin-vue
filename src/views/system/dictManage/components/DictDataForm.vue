<template>
  <el-dialog v-model="visible" append-to-body :title="`${paramsProps.title}`" :destroy-on-close="true" width="580px" draggable>
    ...
    >
      <el-form-item label="字典名称" prop="code_name">
        <el-input v-model="paramsProps.row.code_name" placeholder="请填写字典名称" clearable />
      </el-form-item>
      <el-form-item label="字典值" prop="code">
        <el-input v-model="paramsProps.row.code" placeholder="请填写字典值" clearable />
      </el-form-item>
      ...
      <el-form-item label="回显样式" prop="isFull">
        <el-radio-group v-model="paramsProps.row.callback_show_style" value="1">
...
const rules = reactive({
  code_name: [{ required: true, message: '请填写字典名称' }],
