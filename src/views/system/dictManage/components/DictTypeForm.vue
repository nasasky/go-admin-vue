  ...
  <el-dialog v-model="visible" :title="`${paramsProps.title}`" :destroy-on-close="true" width="580px" draggable append-to-body>
    ...
    >
      ...
      <el-form-item label="字典名称" prop="type_name">
        <el-input v-model="paramsProps.row.type_name" placeholder="请填写字典名称" clearable />
      </el-form-item>
      <el-form-item label="字典类型" prop="type_code">
        <el-input v-model="paramsProps.row.type_code" placeholder="请填写字典类型" clearable />
      </el-form-item>
