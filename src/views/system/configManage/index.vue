<template>
  <div class="table-box">
    <ProTable ref="proTableRef" title="参数列表" :indent="20" :columns="columns" :search-columns="searchColumns"
...
const columns: ColumnProps<IConfig.Info>[] = [
  ...
  { prop: 'appid', label: 'appidValue', tag: true, width: 300 },
  { prop: 'secret', label: 'secretValue', tag: true, width: 300 },
...
const searchColumns: SearchProps[] = [
  { prop: 'seach', label: '参数名称', el: 'input' },
