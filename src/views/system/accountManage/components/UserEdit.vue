<template xmlns:el-col="http://www.w3.org/1999/html">
  <el-dialog v-model="visible" :title="`${paramsProps.title}`" :destroy-on-close="true" width="600px" draggable
    append-to-body>
    <el-form ref="ruleFormRef" label-width="80px" label-suffix=" :" :rules="rules" :model="paramsProps.row"
      ...
      <el-row>
        <el-form-item label="头像" prop="avatar">
          <UploadImg v-model:image-url="paramsProps.row.avatar" @change="fileChange" dir="user" width="135px"
