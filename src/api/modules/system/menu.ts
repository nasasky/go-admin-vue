...
export const getMenuList = (params: IMenu.Query) => {
  return http.get<Menu.MenuOptions[]>(ADMIN_MODULE + `/menu`, params);
};
...
export const addMenu = (params: IMenu.Form) => {
  return http.post(ADMIN_MODULE + `/menu/add`, params);
};
...
export const editMenu = (params: IMenu.Form) => {
  return http.put(ADMIN_MODULE + `/menu/update`, params);
};
...
export const deleteMenu = (params: { ids: string[] }) => {
  return http.delete(ADMIN_MODULE + `/menu/delete`, params);
};
...
export const getMenuInfo = (params: { id: string }) => {
  const { id } = params;
  return http.get(ADMIN_MODULE + `/menu/detail/${id}`);
};
...
export const getMenuTree = (params: { nodeId?: string }) => {
  return http.get<IMenu.Tree[]>(ADMIN_MODULE + `/menu`, params);
};
