...
export const loginApi = (params: ILogin.LoginParams) => {
  ...
  return http.post<ILogin.LoginInfo>(ADMIN_MODULE + `/login`, params, { loading: false }); // 正常 post json 请求  ==>  application/json
...
export const getAuthMenuListApi = () => {
  return http.get<Menu.MenuOptions[]>(ADMIN_MODULE + `/route`, {}, { loading: false });
};
